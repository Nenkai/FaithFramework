...
public unsafe class ImGui : IImGui
{
    public ulong ImTextureRef_GetTexID(ImTextureRef self) => ImGuiMethods.ImTextureRef_GetTexID(self);
    public IImGuiContext CreateContext(IImFontAtlas shared_font_atlas)
    {
        var retPtr = ImGuiMethods.CreateContext(shared_font_atlas is not null ? (ImFontAtlasStruct*)shared_font_atlas.NativePointer : null);
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiContext(retPtr);
        return retImpl;
    }
    ...
    {
        var retPtr = ImGuiMethods.GetCurrentContext();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiContext(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.GetIO();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiIO(retPtr);
        return retImpl;
    }

    public IImGuiPlatformIO GetPlatformIO()
    {
        var retPtr = ImGuiMethods.GetPlatformIO();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiPlatformIO(retPtr);
        return retImpl;
    }

    public IImGuiStyle GetStyle()
    {
        var retPtr = ImGuiMethods.GetStyle();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiStyle(retPtr);
        return retImpl;
    }
    ...
    {
        var retPtr = ImGuiMethods.GetDrawData();
        if (retPtr is null)
        return null !;
        var retImpl = new ImDrawData(retPtr);
        return retImpl;
    }
    ...
    public bool Begin(string name, ref bool p_open, ImGuiWindowFlags flags) => ImGuiMethods.Begin(name, ref p_open, flags);
    public void End() => ImGuiMethods.End();
    public bool BeginChild(string str_id, Vector2 size, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags) => ImGuiMethods.BeginChild(str_id, size, child_flags, window_flags);
    public bool BeginChildID(uint id, Vector2 size, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags) => ImGuiMethods.BeginChildID(id, size, child_flags, window_flags);
    ...
    public bool IsWindowFocused(ImGuiFocusedFlags flags) => ImGuiMethods.IsWindowFocused(flags);
    public bool IsWindowHovered(ImGuiHoveredFlags flags) => ImGuiMethods.IsWindowHovered(flags);
    public IImDrawList GetWindowDrawList()
    {
        var retPtr = ImGuiMethods.GetWindowDrawList();
        if (retPtr is null)
        return null !;
        var retImpl = new ImDrawList(retPtr);
        return retImpl;
    }
    ...
    {
        var retPtr = ImGuiMethods.GetWindowViewport();
        if (retPtr is null)
        return null !;
    ...
    public void SetNextWindowPos(Vector2 pos, ImGuiCond cond) => ImGuiMethods.SetNextWindowPos(pos, cond);
    public void SetNextWindowPosEx(Vector2 pos, ImGuiCond cond, Vector2 pivot) => ImGuiMethods.SetNextWindowPosEx(pos, cond, pivot);
    public void SetNextWindowSize(Vector2 size, ImGuiCond cond) => ImGuiMethods.SetNextWindowSize(size, cond);
    ...
    public void SetNextWindowCollapsed(bool collapsed, ImGuiCond cond) => ImGuiMethods.SetNextWindowCollapsed(collapsed, cond);
    ...
    public void SetWindowPos(Vector2 pos, ImGuiCond cond) => ImGuiMethods.SetWindowPos(pos, cond);
    public void SetWindowSize(Vector2 size, ImGuiCond cond) => ImGuiMethods.SetWindowSize(size, cond);
    public void SetWindowCollapsed(bool collapsed, ImGuiCond cond) => ImGuiMethods.SetWindowCollapsed(collapsed, cond);
    public void SetWindowFocus() => ImGuiMethods.SetWindowFocus();
    public void SetWindowPosStr(string name, Vector2 pos, ImGuiCond cond) => ImGuiMethods.SetWindowPosStr(name, pos, cond);
    public void SetWindowSizeStr(string name, Vector2 size, ImGuiCond cond) => ImGuiMethods.SetWindowSizeStr(name, size, cond);
    public void SetWindowCollapsedStr(string name, bool collapsed, ImGuiCond cond) => ImGuiMethods.SetWindowCollapsedStr(name, collapsed, cond);
    ...
    {
        var retPtr = ImGuiMethods.GetFont();
        if (retPtr is null)
        return null !;
        var retImpl = new ImFont(retPtr);
        return retImpl;
    }
    ...
    {
        var retPtr = ImGuiMethods.GetFontBaked();
        if (retPtr is null)
        return null !;
        var retImpl = new ImFontBaked(retPtr);
        return retImpl;
    }

    public void PushStyleColor(ImGuiCol idx, uint col) => ImGuiMethods.PushStyleColor(idx, col);
    public void PushStyleColorImVec4(ImGuiCol idx, Vector4 col) => ImGuiMethods.PushStyleColorImVec4(idx, col);
    ...
    public void PushStyleVar(ImGuiStyleVar idx, float val) => ImGuiMethods.PushStyleVar(idx, val);
    public void PushStyleVarImVec2(ImGuiStyleVar idx, Vector2 val) => ImGuiMethods.PushStyleVarImVec2(idx, val);
    public void PushStyleVarX(ImGuiStyleVar idx, float val_x) => ImGuiMethods.PushStyleVarX(idx, val_x);
    public void PushStyleVarY(ImGuiStyleVar idx, float val_y) => ImGuiMethods.PushStyleVarY(idx, val_y);
    public void PopStyleVar() => ImGuiMethods.PopStyleVar();
    public void PopStyleVarEx(int count) => ImGuiMethods.PopStyleVarEx(count);
    public void PushItemFlag(ImGuiItemFlags option, bool enabled) => ImGuiMethods.PushItemFlag(option, enabled);
    ...
    public uint GetColorU32(ImGuiCol idx) => ImGuiMethods.GetColorU32(idx);
    public uint GetColorU32Ex(ImGuiCol idx, float alpha_mul) => ImGuiMethods.GetColorU32Ex(idx, alpha_mul);
    ...
    public Vector4 GetStyleColorVec4(ImGuiCol idx) => ImGuiMethods.GetStyleColorVec4(idx);
    ...
    public bool InvisibleButton(string str_id, Vector2 size, ImGuiButtonFlags flags) => ImGuiMethods.InvisibleButton(str_id, size, flags);
    ...
    public void Image(ImTextureRef tex_ref, Vector2 image_size) => ImGuiMethods.Image(tex_ref, image_size);
    public void ImageEx(ImTextureRef tex_ref, Vector2 image_size, Vector2 uv0, Vector2 uv1) => ImGuiMethods.ImageEx(tex_ref, image_size, uv0, uv1);
    public void ImageWithBg(ImTextureRef tex_ref, Vector2 image_size) => ImGuiMethods.ImageWithBg(tex_ref, image_size);
    public void ImageWithBgEx(ImTextureRef tex_ref, Vector2 image_size, Vector2 uv0, Vector2 uv1, Vector4 bg_col, Vector4 tint_col) => ImGuiMethods.ImageWithBgEx(tex_ref, image_size, uv0, uv1, bg_col, tint_col);
    public bool ImageButton(string str_id, ImTextureRef tex_ref, Vector2 image_size) => ImGuiMethods.ImageButton(str_id, tex_ref, image_size);
    public bool ImageButtonEx(string str_id, ImTextureRef tex_ref, Vector2 image_size, Vector2 uv0, Vector2 uv1, Vector4 bg_col, Vector4 tint_col) => ImGuiMethods.ImageButtonEx(str_id, tex_ref, image_size, uv0, uv1, bg_col, tint_col);
    public bool BeginCombo(string label, string preview_value, ImGuiComboFlags flags) => ImGuiMethods.BeginCombo(label, preview_value, flags);
    ...
    public bool DragFloatEx(string label, ref float v, float v_speed, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragFloatEx(label, ref v, v_speed, v_min, v_max, format, flags);
    public bool DragFloat2(string label, ref float v) => ImGuiMethods.DragFloat2(label, ref v);
    public bool DragFloat2Ex(string label, ref float v, float v_speed, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragFloat2Ex(label, ref v, v_speed, v_min, v_max, format, flags);
    public bool DragFloat3(string label, ref float v) => ImGuiMethods.DragFloat3(label, ref v);
    public bool DragFloat3Ex(string label, ref float v, float v_speed, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragFloat3Ex(label, ref v, v_speed, v_min, v_max, format, flags);
    public bool DragFloat4(string label, ref float v) => ImGuiMethods.DragFloat4(label, ref v);
    public bool DragFloat4Ex(string label, ref float v, float v_speed, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragFloat4Ex(label, ref v, v_speed, v_min, v_max, format, flags);
    ...
    public bool DragFloatRange2Ex(string label, ref float v_current_min, ref float v_current_max, float v_speed, float v_min, float v_max, string format, string format_max, ImGuiSliderFlags flags) => ImGuiMethods.DragFloatRange2Ex(label, ref v_current_min, ref v_current_max, v_speed, v_min, v_max, format, format_max, flags);
    public bool DragInt(string label, ref int v) => ImGuiMethods.DragInt(label, ref v);
    public bool DragIntEx(string label, ref int v, float v_speed, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragIntEx(label, ref v, v_speed, v_min, v_max, format, flags);
    public bool DragInt2(string label, ref int v) => ImGuiMethods.DragInt2(label, ref v);
    public bool DragInt2Ex(string label, ref int v, float v_speed, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragInt2Ex(label, ref v, v_speed, v_min, v_max, format, flags);
    public bool DragInt3(string label, ref int v) => ImGuiMethods.DragInt3(label, ref v);
    public bool DragInt3Ex(string label, ref int v, float v_speed, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragInt3Ex(label, ref v, v_speed, v_min, v_max, format, flags);
    public bool DragInt4(string label, ref int v) => ImGuiMethods.DragInt4(label, ref v);
    public bool DragInt4Ex(string label, ref int v, float v_speed, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragInt4Ex(label, ref v, v_speed, v_min, v_max, format, flags);
    ...
    public bool DragIntRange2Ex(string label, ref int v_current_min, ref int v_current_max, float v_speed, int v_min, int v_max, string format, string format_max, ImGuiSliderFlags flags) => ImGuiMethods.DragIntRange2Ex(label, ref v_current_min, ref v_current_max, v_speed, v_min, v_max, format, format_max, flags);
    public bool DragScalar(string label, ImGuiDataType data_type, void* p_data) => ImGuiMethods.DragScalar(label, data_type, p_data);
    public bool DragScalarEx(string label, ImGuiDataType data_type, void* p_data, float v_speed, void* p_min, void* p_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragScalarEx(label, data_type, p_data, v_speed, p_min, p_max, format, flags);
    public bool DragScalarN(string label, ImGuiDataType data_type, void* p_data, int components) => ImGuiMethods.DragScalarN(label, data_type, p_data, components);
    public bool DragScalarNEx(string label, ImGuiDataType data_type, void* p_data, int components, float v_speed, void* p_min, void* p_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.DragScalarNEx(label, data_type, p_data, components, v_speed, p_min, p_max, format, flags);
    ...
    public bool SliderFloatEx(string label, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderFloatEx(label, ref v, v_min, v_max, format, flags);
    ...
    public bool SliderFloat2Ex(string label, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderFloat2Ex(label, ref v, v_min, v_max, format, flags);
    ...
    public bool SliderFloat3Ex(string label, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderFloat3Ex(label, ref v, v_min, v_max, format, flags);
    ...
    public bool SliderFloat4Ex(string label, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderFloat4Ex(label, ref v, v_min, v_max, format, flags);
    public bool SliderAngle(string label, ref float v_rad) => ImGuiMethods.SliderAngle(label, ref v_rad);
    public bool SliderAngleEx(string label, ref float v_rad, float v_degrees_min, float v_degrees_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderAngleEx(label, ref v_rad, v_degrees_min, v_degrees_max, format, flags);
    public bool SliderInt(string label, ref int v, int v_min, int v_max) => ImGuiMethods.SliderInt(label, ref v, v_min, v_max);
    public bool SliderIntEx(string label, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderIntEx(label, ref v, v_min, v_max, format, flags);
    public bool SliderInt2(string label, ref int v, int v_min, int v_max) => ImGuiMethods.SliderInt2(label, ref v, v_min, v_max);
    public bool SliderInt2Ex(string label, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderInt2Ex(label, ref v, v_min, v_max, format, flags);
    public bool SliderInt3(string label, ref int v, int v_min, int v_max) => ImGuiMethods.SliderInt3(label, ref v, v_min, v_max);
    public bool SliderInt3Ex(string label, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderInt3Ex(label, ref v, v_min, v_max, format, flags);
    public bool SliderInt4(string label, ref int v, int v_min, int v_max) => ImGuiMethods.SliderInt4(label, ref v, v_min, v_max);
    public bool SliderInt4Ex(string label, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderInt4Ex(label, ref v, v_min, v_max, format, flags);
    public bool SliderScalar(string label, ImGuiDataType data_type, void* p_data, void* p_min, void* p_max) => ImGuiMethods.SliderScalar(label, data_type, p_data, p_min, p_max);
    public bool SliderScalarEx(string label, ImGuiDataType data_type, void* p_data, void* p_min, void* p_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderScalarEx(label, data_type, p_data, p_min, p_max, format, flags);
    public bool SliderScalarN(string label, ImGuiDataType data_type, void* p_data, int components, void* p_min, void* p_max) => ImGuiMethods.SliderScalarN(label, data_type, p_data, components, p_min, p_max);
    public bool SliderScalarNEx(string label, ImGuiDataType data_type, void* p_data, int components, void* p_min, void* p_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.SliderScalarNEx(label, data_type, p_data, components, p_min, p_max, format, flags);
    ...
    public bool VSliderFloatEx(string label, Vector2 size, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.VSliderFloatEx(label, size, ref v, v_min, v_max, format, flags);
    ...
    public bool VSliderIntEx(string label, Vector2 size, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.VSliderIntEx(label, size, ref v, v_min, v_max, format, flags);
    public bool VSliderScalar(string label, Vector2 size, ImGuiDataType data_type, void* p_data, void* p_min, void* p_max) => ImGuiMethods.VSliderScalar(label, size, data_type, p_data, p_min, p_max);
    public bool VSliderScalarEx(string label, Vector2 size, ImGuiDataType data_type, void* p_data, void* p_min, void* p_max, string format, ImGuiSliderFlags flags) => ImGuiMethods.VSliderScalarEx(label, size, data_type, p_data, p_min, p_max, format, flags);
    public bool InputText(string label, sbyte* buf, nuint buf_size, ImGuiInputTextFlags flags) => ImGuiMethods.InputText(label, buf, buf_size, flags);
    public bool InputTextEx(string label, sbyte* buf, nuint buf_size, ImGuiInputTextFlags flags, delegate* unmanaged[Cdecl]<nint, int> callback, void* user_data) => ImGuiMethods.InputTextEx(label, buf, buf_size, flags, callback, user_data);
    public bool InputTextMultiline(string label, sbyte* buf, nuint buf_size) => ImGuiMethods.InputTextMultiline(label, buf, buf_size);
    public bool InputTextMultilineEx(string label, sbyte* buf, nuint buf_size, Vector2 size, ImGuiInputTextFlags flags, delegate* unmanaged[Cdecl]<nint, int> callback, void* user_data) => ImGuiMethods.InputTextMultilineEx(label, buf, buf_size, size, flags, callback, user_data);
    public bool InputTextWithHint(string label, string hint, sbyte* buf, nuint buf_size, ImGuiInputTextFlags flags) => ImGuiMethods.InputTextWithHint(label, hint, buf, buf_size, flags);
    public bool InputTextWithHintEx(string label, string hint, sbyte* buf, nuint buf_size, ImGuiInputTextFlags flags, delegate* unmanaged[Cdecl]<nint, int> callback, void* user_data) => ImGuiMethods.InputTextWithHintEx(label, hint, buf, buf_size, flags, callback, user_data);
    public bool InputFloat(string label, ref float v) => ImGuiMethods.InputFloat(label, ref v);
    public bool InputFloatEx(string label, ref float v, float step, float step_fast, string format, ImGuiInputTextFlags flags) => ImGuiMethods.InputFloatEx(label, ref v, step, step_fast, format, flags);
    public bool InputFloat2(string label, ref float v) => ImGuiMethods.InputFloat2(label, ref v);
    public bool InputFloat2Ex(string label, ref float v, string format, ImGuiInputTextFlags flags) => ImGuiMethods.InputFloat2Ex(label, ref v, format, flags);
    public bool InputFloat3(string label, ref float v) => ImGuiMethods.InputFloat3(label, ref v);
    public bool InputFloat3Ex(string label, ref float v, string format, ImGuiInputTextFlags flags) => ImGuiMethods.InputFloat3Ex(label, ref v, format, flags);
    public bool InputFloat4(string label, ref float v) => ImGuiMethods.InputFloat4(label, ref v);
    public bool InputFloat4Ex(string label, ref float v, string format, ImGuiInputTextFlags flags) => ImGuiMethods.InputFloat4Ex(label, ref v, format, flags);
    public bool InputInt(string label, ref int v) => ImGuiMethods.InputInt(label, ref v);
    public bool InputIntEx(string label, ref int v, int step, int step_fast, ImGuiInputTextFlags flags) => ImGuiMethods.InputIntEx(label, ref v, step, step_fast, flags);
    public bool InputInt2(string label, ref int v, ImGuiInputTextFlags flags) => ImGuiMethods.InputInt2(label, ref v, flags);
    public bool InputInt3(string label, ref int v, ImGuiInputTextFlags flags) => ImGuiMethods.InputInt3(label, ref v, flags);
    public bool InputInt4(string label, ref int v, ImGuiInputTextFlags flags) => ImGuiMethods.InputInt4(label, ref v, flags);
    public bool InputDouble(string label, ref double v) => ImGuiMethods.InputDouble(label, ref v);
    public bool InputDoubleEx(string label, ref double v, double step, double step_fast, string format, ImGuiInputTextFlags flags) => ImGuiMethods.InputDoubleEx(label, ref v, step, step_fast, format, flags);
    public bool InputScalar(string label, ImGuiDataType data_type, void* p_data) => ImGuiMethods.InputScalar(label, data_type, p_data);
    public bool InputScalarEx(string label, ImGuiDataType data_type, void* p_data, void* p_step, void* p_step_fast, string format, ImGuiInputTextFlags flags) => ImGuiMethods.InputScalarEx(label, data_type, p_data, p_step, p_step_fast, format, flags);
    public bool InputScalarN(string label, ImGuiDataType data_type, void* p_data, int components) => ImGuiMethods.InputScalarN(label, data_type, p_data, components);
    public bool InputScalarNEx(string label, ImGuiDataType data_type, void* p_data, int components, void* p_step, void* p_step_fast, string format, ImGuiInputTextFlags flags) => ImGuiMethods.InputScalarNEx(label, data_type, p_data, components, p_step, p_step_fast, format, flags);
    public bool ColorEdit3(string label, ref float col, ImGuiColorEditFlags flags) => ImGuiMethods.ColorEdit3(label, ref col, flags);
    public bool ColorEdit4(string label, ref float col, ImGuiColorEditFlags flags) => ImGuiMethods.ColorEdit4(label, ref col, flags);
    public bool ColorPicker3(string label, ref float col, ImGuiColorEditFlags flags) => ImGuiMethods.ColorPicker3(label, ref col, flags);
    public bool ColorPicker4(string label, ref float col, ImGuiColorEditFlags flags, ref float ref_col) => ImGuiMethods.ColorPicker4(label, ref col, flags, ref ref_col);
    public bool ColorButton(string desc_id, Vector4 col, ImGuiColorEditFlags flags) => ImGuiMethods.ColorButton(desc_id, col, flags);
    public bool ColorButtonEx(string desc_id, Vector4 col, ImGuiColorEditFlags flags, Vector2 size) => ImGuiMethods.ColorButtonEx(desc_id, col, flags, size);
    public void SetColorEditOptions(ImGuiColorEditFlags flags) => ImGuiMethods.SetColorEditOptions(flags);
    ...
    public bool TreeNodeEx(string label, ImGuiTreeNodeFlags flags) => ImGuiMethods.TreeNodeEx(label, flags);
    public bool TreeNodeExStr(string str_id, ImGuiTreeNodeFlags flags, string fmt) => ImGuiMethods.TreeNodeExStr(str_id, flags, fmt);
    public bool TreeNodeExPtr(void* ptr_id, ImGuiTreeNodeFlags flags, string fmt) => ImGuiMethods.TreeNodeExPtr(ptr_id, flags, fmt);
    public bool TreeNodeExV(string str_id, ImGuiTreeNodeFlags flags, string fmt, sbyte* args) => ImGuiMethods.TreeNodeExV(str_id, flags, fmt, args);
    public bool TreeNodeExVPtr(void* ptr_id, ImGuiTreeNodeFlags flags, string fmt, sbyte* args) => ImGuiMethods.TreeNodeExVPtr(ptr_id, flags, fmt, args);
    ...
    public bool CollapsingHeader(string label, ImGuiTreeNodeFlags flags) => ImGuiMethods.CollapsingHeader(label, flags);
    public bool CollapsingHeaderBoolPtr(string label, ref bool p_visible, ImGuiTreeNodeFlags flags) => ImGuiMethods.CollapsingHeaderBoolPtr(label, ref p_visible, flags);
    public void SetNextItemOpen(bool is_open, ImGuiCond cond) => ImGuiMethods.SetNextItemOpen(is_open, cond);
    ...
    public bool SelectableEx(string label, bool selected, ImGuiSelectableFlags flags, Vector2 size) => ImGuiMethods.SelectableEx(label, selected, flags, size);
    public bool SelectableBoolPtr(string label, ref bool p_selected, ImGuiSelectableFlags flags) => ImGuiMethods.SelectableBoolPtr(label, ref p_selected, flags);
    public bool SelectableBoolPtrEx(string label, ref bool p_selected, ImGuiSelectableFlags flags, Vector2 size) => ImGuiMethods.SelectableBoolPtrEx(label, ref p_selected, flags, size);
    public IImGuiMultiSelectIO BeginMultiSelect(ImGuiMultiSelectFlags flags)
    {
        var retPtr = ImGuiMethods.BeginMultiSelect(flags);
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiMultiSelectIO(retPtr);
        return retImpl;
    }

    public IImGuiMultiSelectIO BeginMultiSelectEx(ImGuiMultiSelectFlags flags, int selection_size, int items_count)
    {
        var retPtr = ImGuiMethods.BeginMultiSelectEx(flags, selection_size, items_count);
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiMultiSelectIO(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.EndMultiSelect();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiMultiSelectIO(retPtr);
        return retImpl;
    ...
    public bool BeginPopup(string str_id, ImGuiWindowFlags flags) => ImGuiMethods.BeginPopup(str_id, flags);
    public bool BeginPopupModal(string name, ref bool p_open, ImGuiWindowFlags flags) => ImGuiMethods.BeginPopupModal(name, ref p_open, flags);
    public void EndPopup() => ImGuiMethods.EndPopup();
    public void OpenPopup(string str_id, ImGuiPopupFlags popup_flags) => ImGuiMethods.OpenPopup(str_id, popup_flags);
    public void OpenPopupID(uint id, ImGuiPopupFlags popup_flags) => ImGuiMethods.OpenPopupID(id, popup_flags);
    public void OpenPopupOnItemClick(string str_id, ImGuiPopupFlags popup_flags) => ImGuiMethods.OpenPopupOnItemClick(str_id, popup_flags);
    ...
    public bool BeginPopupContextItemEx(string str_id, ImGuiPopupFlags popup_flags) => ImGuiMethods.BeginPopupContextItemEx(str_id, popup_flags);
    public bool BeginPopupContextWindow() => ImGuiMethods.BeginPopupContextWindow();
    public bool BeginPopupContextWindowEx(string str_id, ImGuiPopupFlags popup_flags) => ImGuiMethods.BeginPopupContextWindowEx(str_id, popup_flags);
    public bool BeginPopupContextVoid() => ImGuiMethods.BeginPopupContextVoid();
    public bool BeginPopupContextVoidEx(string str_id, ImGuiPopupFlags popup_flags) => ImGuiMethods.BeginPopupContextVoidEx(str_id, popup_flags);
    public bool IsPopupOpen(string str_id, ImGuiPopupFlags flags) => ImGuiMethods.IsPopupOpen(str_id, flags);
    public bool BeginTable(string str_id, int columns, ImGuiTableFlags flags) => ImGuiMethods.BeginTable(str_id, columns, flags);
    public bool BeginTableEx(string str_id, int columns, ImGuiTableFlags flags, Vector2 outer_size, float inner_width) => ImGuiMethods.BeginTableEx(str_id, columns, flags, outer_size, inner_width);
    public void EndTable() => ImGuiMethods.EndTable();
    public void TableNextRow() => ImGuiMethods.TableNextRow();
    public void TableNextRowEx(ImGuiTableRowFlags row_flags, float min_row_height) => ImGuiMethods.TableNextRowEx(row_flags, min_row_height);
    ...
    public void TableSetupColumn(string label, ImGuiTableColumnFlags flags) => ImGuiMethods.TableSetupColumn(label, flags);
    public void TableSetupColumnEx(string label, ImGuiTableColumnFlags flags, float init_width_or_weight, uint user_id) => ImGuiMethods.TableSetupColumnEx(label, flags, init_width_or_weight, user_id);
    ...
    {
        var retPtr = ImGuiMethods.TableGetSortSpecs();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiTableSortSpecs(retPtr);
        return retImpl;
    }
    ...
    public ImGuiTableColumnFlags TableGetColumnFlags(int column_n) => ImGuiMethods.TableGetColumnFlags(column_n);
    ...
    public void TableSetBgColor(ImGuiTableBgTarget target, uint color, int column_n) => ImGuiMethods.TableSetBgColor(target, color, column_n);
    ...
    public bool BeginTabBar(string str_id, ImGuiTabBarFlags flags) => ImGuiMethods.BeginTabBar(str_id, flags);
    public void EndTabBar() => ImGuiMethods.EndTabBar();
    public bool BeginTabItem(string label, ref bool p_open, ImGuiTabItemFlags flags) => ImGuiMethods.BeginTabItem(label, ref p_open, flags);
    public void EndTabItem() => ImGuiMethods.EndTabItem();
    public bool TabItemButton(string label, ImGuiTabItemFlags flags) => ImGuiMethods.TabItemButton(label, flags);
    ...
    public uint DockSpaceEx(uint dockspace_id, Vector2 size, ImGuiDockNodeFlags flags, IImGuiWindowClass window_class) => ImGuiMethods.DockSpaceEx(dockspace_id, size, flags, window_class is not null ? (ImGuiWindowClassStruct*)window_class.NativePointer : null);
    public uint DockSpaceOverViewport() => ImGuiMethods.DockSpaceOverViewport();
    public uint DockSpaceOverViewportEx(uint dockspace_id, IImGuiViewport viewport, ImGuiDockNodeFlags flags, IImGuiWindowClass window_class) => ImGuiMethods.DockSpaceOverViewportEx(dockspace_id, viewport is not null ? (ImGuiViewportStruct*)viewport.NativePointer : null, flags, window_class is not null ? (ImGuiWindowClassStruct*)window_class.NativePointer : null);
    public void SetNextWindowDockID(uint dock_id, ImGuiCond cond) => ImGuiMethods.SetNextWindowDockID(dock_id, cond);
    ...
    public bool BeginDragDropSource(ImGuiDragDropFlags flags) => ImGuiMethods.BeginDragDropSource(flags);
    public bool SetDragDropPayload(string type, void* data, nuint sz, ImGuiCond cond) => ImGuiMethods.SetDragDropPayload(type, data, sz, cond);
    ...
    {
        var retPtr = ImGuiMethods.AcceptDragDropPayload(type, flags);
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiPayload(retPtr);
        return retImpl;
    }
    ...
    {
        var retPtr = ImGuiMethods.GetDragDropPayload();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiPayload(retPtr);
        return retImpl;
    ...
    public bool IsItemHovered(ImGuiHoveredFlags flags) => ImGuiMethods.IsItemHovered(flags);
    ...
    public bool IsItemClickedEx(ImGuiMouseButton mouse_button) => ImGuiMethods.IsItemClickedEx(mouse_button);
    ...
    {
        var retPtr = ImGuiMethods.GetMainViewport();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiViewport(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.GetBackgroundDrawList();
        if (retPtr is null)
        return null !;
        var retImpl = new ImDrawList(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.GetBackgroundDrawListEx(viewport is not null ? (ImGuiViewportStruct*)viewport.NativePointer : null);
        if (retPtr is null)
        return null !;
        var retImpl = new ImDrawList(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.GetForegroundDrawList();
        if (retPtr is null)
        return null !;
        var retImpl = new ImDrawList(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.GetForegroundDrawListEx(viewport is not null ? (ImGuiViewportStruct*)viewport.NativePointer : null);
        if (retPtr is null)
        return null !;
        var retImpl = new ImDrawList(retPtr);
        return retImpl;
    ...
    {
        sbyte* retStrPtr = ImGuiMethods.GetStyleColorName(idx);
        if (retStrPtr is null)
        return null !;
        string retStr = Marshal.PtrToStringUTF8((nint)retStrPtr)!;
        return retStr;
    ...
    {
        var retPtr = ImGuiMethods.GetStateStorage();
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiStorage(retPtr);
        return retImpl;
    }
    ...
    public bool Shortcut(int key_chord, ImGuiInputFlags flags) => ImGuiMethods.Shortcut(key_chord, flags);
    public void SetNextItemShortcut(int key_chord, ImGuiInputFlags flags) => ImGuiMethods.SetNextItemShortcut(key_chord, flags);
    public void SetItemKeyOwner(int key) => ImGuiMethods.SetItemKeyOwner(key);
    public bool IsMouseDown(ImGuiMouseButton button) => ImGuiMethods.IsMouseDown(button);
    public bool IsMouseClicked(ImGuiMouseButton button) => ImGuiMethods.IsMouseClicked(button);
    public bool IsMouseClickedEx(ImGuiMouseButton button, bool repeat) => ImGuiMethods.IsMouseClickedEx(button, repeat);
    public bool IsMouseReleased(ImGuiMouseButton button) => ImGuiMethods.IsMouseReleased(button);
    public bool IsMouseDoubleClicked(ImGuiMouseButton button) => ImGuiMethods.IsMouseDoubleClicked(button);
    public bool IsMouseReleasedWithDelay(ImGuiMouseButton button, float delay) => ImGuiMethods.IsMouseReleasedWithDelay(button, delay);
    public int GetMouseClickedCount(ImGuiMouseButton button) => ImGuiMethods.GetMouseClickedCount(button);
    ...
    public bool IsMouseDragging(ImGuiMouseButton button, float lock_threshold) => ImGuiMethods.IsMouseDragging(button, lock_threshold);
    public Vector2 GetMouseDragDelta(ImGuiMouseButton button, float lock_threshold) => ImGuiMethods.GetMouseDragDelta(button, lock_threshold);
    public void ResetMouseDragDelta() => ImGuiMethods.ResetMouseDragDelta();
    public void ResetMouseDragDeltaEx(ImGuiMouseButton button) => ImGuiMethods.ResetMouseDragDeltaEx(button);
    public ImGuiMouseCursor GetMouseCursor() => ImGuiMethods.GetMouseCursor();
    public void SetMouseCursor(ImGuiMouseCursor cursor_type) => ImGuiMethods.SetMouseCursor(cursor_type);
    ...
    public void DebugFlashStyleColor(ImGuiCol idx) => ImGuiMethods.DebugFlashStyleColor(idx);
    ...
    {
        var retPtr = ImGuiMethods.FindViewportByPlatformHandle(platform_handle);
        if (retPtr is null)
        return null !;
        var retImpl = new ImGuiViewport(retPtr);
        return retImpl;
    ...
    public void ImGuiTextFilter_ImGuiTextRange_split(IImGuiTextFilter_ImGuiTextRange self, sbyte separator, ImStructVectorWrapper<IImGuiTextFilter_ImGuiTextRange> @out) => ImGuiMethods.ImGuiTextFilter_ImGuiTextRange_split(self is not null ? (ImGuiTextFilter_ImGuiTextRangeStruct*)self.NativePointer : null, separator, ref Unsafe.AsRef<ImVector<ImGuiTextFilter_ImGuiTextRangeStruct>>(&@out.Size));
    ...
    public void ImDrawList_PushTexture(IImDrawList self, ImTextureRef tex_ref) => ImGuiMethods.ImDrawList_PushTexture(self is not null ? (ImDrawListStruct*)self.NativePointer : null, tex_ref);
    ...
    public void ImDrawList_AddRectEx(IImDrawList self, Vector2 p_min, Vector2 p_max, uint col, float rounding, ImDrawFlags flags, float thickness) => ImGuiMethods.ImDrawList_AddRectEx(self is not null ? (ImDrawListStruct*)self.NativePointer : null, p_min, p_max, col, rounding, flags, thickness);
    ...
    public void ImDrawList_AddRectFilledEx(IImDrawList self, Vector2 p_min, Vector2 p_max, uint col, float rounding, ImDrawFlags flags) => ImGuiMethods.ImDrawList_AddRectFilledEx(self is not null ? (ImDrawListStruct*)self.NativePointer : null, p_min, p_max, col, rounding, flags);
    ...
    public void ImDrawList_AddPolyline(IImDrawList self, Vector2 points, int num_points, uint col, ImDrawFlags flags, float thickness) => ImGuiMethods.ImDrawList_AddPolyline(self is not null ? (ImDrawListStruct*)self.NativePointer : null, points, num_points, col, flags, thickness);
    ...
    public void ImDrawList_AddImage(IImDrawList self, ImTextureRef tex_ref, Vector2 p_min, Vector2 p_max) => ImGuiMethods.ImDrawList_AddImage(self is not null ? (ImDrawListStruct*)self.NativePointer : null, tex_ref, p_min, p_max);
    public void ImDrawList_AddImageEx(IImDrawList self, ImTextureRef tex_ref, Vector2 p_min, Vector2 p_max, Vector2 uv_min, Vector2 uv_max, uint col) => ImGuiMethods.ImDrawList_AddImageEx(self is not null ? (ImDrawListStruct*)self.NativePointer : null, tex_ref, p_min, p_max, uv_min, uv_max, col);
    public void ImDrawList_AddImageQuad(IImDrawList self, ImTextureRef tex_ref, Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4) => ImGuiMethods.ImDrawList_AddImageQuad(self is not null ? (ImDrawListStruct*)self.NativePointer : null, tex_ref, p1, p2, p3, p4);
    public void ImDrawList_AddImageQuadEx(IImDrawList self, ImTextureRef tex_ref, Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, Vector2 uv1, Vector2 uv2, Vector2 uv3, Vector2 uv4, uint col) => ImGuiMethods.ImDrawList_AddImageQuadEx(self is not null ? (ImDrawListStruct*)self.NativePointer : null, tex_ref, p1, p2, p3, p4, uv1, uv2, uv3, uv4, col);
    public void ImDrawList_AddImageRounded(IImDrawList self, ImTextureRef tex_ref, Vector2 p_min, Vector2 p_max, Vector2 uv_min, Vector2 uv_max, uint col, float rounding, ImDrawFlags flags) => ImGuiMethods.ImDrawList_AddImageRounded(self is not null ? (ImDrawListStruct*)self.NativePointer : null, tex_ref, p_min, p_max, uv_min, uv_max, col, rounding, flags);
    ...
    public void ImDrawList_PathStroke(IImDrawList self, uint col, ImDrawFlags flags, float thickness) => ImGuiMethods.ImDrawList_PathStroke(self is not null ? (ImDrawListStruct*)self.NativePointer : null, col, flags, thickness);
    ...
    public void ImDrawList_PathRect(IImDrawList self, Vector2 rect_min, Vector2 rect_max, float rounding, ImDrawFlags flags) => ImGuiMethods.ImDrawList_PathRect(self is not null ? (ImDrawListStruct*)self.NativePointer : null, rect_min, rect_max, rounding, flags);
    ...
    {
        var retPtr = ImGuiMethods.ImDrawList_CloneOutput(self is not null ? (ImDrawListStruct*)self.NativePointer : null);
        if (retPtr is null)
        return null !;
        var retImpl = new ImDrawList(retPtr);
        return retImpl;
    ...
    public void ImDrawList_PushTextureID(IImDrawList self, ImTextureRef tex_ref) => ImGuiMethods.ImDrawList_PushTextureID(self is not null ? (ImDrawListStruct*)self.NativePointer : null, tex_ref);
    ...
    public void ImDrawList__SetTexture(IImDrawList self, ImTextureRef tex_ref) => ImGuiMethods.ImDrawList__SetTexture(self is not null ? (ImDrawListStruct*)self.NativePointer : null, tex_ref);
    ...
    public void ImTextureData_Create(IImTextureData self, ImTextureFormat format, int w, int h) => ImGuiMethods.ImTextureData_Create(self is not null ? (ImTextureDataStruct*)self.NativePointer : null, format, w, h);
    ...
    public ImTextureRef ImTextureData_GetTexRef(IImTextureData self) => ImGuiMethods.ImTextureData_GetTexRef(self is not null ? (ImTextureDataStruct*)self.NativePointer : null);
    ...
    public void ImTextureData_SetStatus(IImTextureData self, ImTextureStatus status) => ImGuiMethods.ImTextureData_SetStatus(self is not null ? (ImTextureDataStruct*)self.NativePointer : null, status);
    ...
    public void ImFontGlyphRangesBuilder_BuildRanges(IImFontGlyphRangesBuilder self, ref ImVector<uint> out_ranges) => ImGuiMethods.ImFontGlyphRangesBuilder_BuildRanges(self is not null ? (ImFontGlyphRangesBuilderStruct*)self.NativePointer : null, ref out_ranges);
    public IImFont ImFontAtlas_AddFont(IImFontAtlas self, IImFontConfig font_cfg)
    {
        var retPtr = ImGuiMethods.ImFontAtlas_AddFont(self is not null ? (ImFontAtlasStruct*)self.NativePointer : null, font_cfg is not null ? (ImFontConfigStruct*)font_cfg.NativePointer : null);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFont(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.ImFontAtlas_AddFontDefault(self is not null ? (ImFontAtlasStruct*)self.NativePointer : null, font_cfg is not null ? (ImFontConfigStruct*)font_cfg.NativePointer : null);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFont(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.ImFontAtlas_AddFontFromFileTTF(self is not null ? (ImFontAtlasStruct*)self.NativePointer : null, filename, size_pixels, font_cfg is not null ? (ImFontConfigStruct*)font_cfg.NativePointer : null, ref glyph_ranges);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFont(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.ImFontAtlas_AddFontFromMemoryTTF(self is not null ? (ImFontAtlasStruct*)self.NativePointer : null, font_data, font_data_size, size_pixels, font_cfg is not null ? (ImFontConfigStruct*)font_cfg.NativePointer : null, ref glyph_ranges);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFont(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.ImFontAtlas_AddFontFromMemoryCompressedTTF(self is not null ? (ImFontAtlasStruct*)self.NativePointer : null, compressed_font_data, compressed_font_data_size, size_pixels, font_cfg is not null ? (ImFontConfigStruct*)font_cfg.NativePointer : null, ref glyph_ranges);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFont(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.ImFontAtlas_AddFontFromMemoryCompressedBase85TTF(self is not null ? (ImFontAtlasStruct*)self.NativePointer : null, compressed_font_data_base85, size_pixels, font_cfg is not null ? (ImFontConfigStruct*)font_cfg.NativePointer : null, ref glyph_ranges);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFont(retPtr);
        return retImpl;
    ...
    public void ImFontAtlas_SetTexIDImTextureRef(IImFontAtlas self, ImTextureRef id) => ImGuiMethods.ImFontAtlas_SetTexIDImTextureRef(self is not null ? (ImFontAtlasStruct*)self.NativePointer : null, id);
    ...
    {
        var retPtr = ImGuiMethods.ImFontAtlas_GetCustomRectByIndex(self is not null ? (ImFontAtlasStruct*)self.NativePointer : null, id);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFontAtlasRect(retPtr);
        return retImpl;
    }
    ...
    {
        var retPtr = ImGuiMethods.ImFontBaked_FindGlyph(self is not null ? (ImFontBakedStruct*)self.NativePointer : null, c);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFontGlyph(retPtr);
        return retImpl;
    }

    public IImFontGlyph ImFontBaked_FindGlyphNoFallback(IImFontBaked self, uint c)
    {
        var retPtr = ImGuiMethods.ImFontBaked_FindGlyphNoFallback(self is not null ? (ImFontBakedStruct*)self.NativePointer : null, c);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFontGlyph(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.ImFont_GetFontBaked(self is not null ? (ImFontStruct*)self.NativePointer : null, font_size);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFontBaked(retPtr);
        return retImpl;
    ...
    {
        var retPtr = ImGuiMethods.ImFont_GetFontBakedEx(self is not null ? (ImFontStruct*)self.NativePointer : null, font_size, density);
        if (retPtr is null)
        return null !;
        var retImpl = new ImFontBaked(retPtr);
        return retImpl;
    ...
    public bool BeginChildFrameEx(uint id, Vector2 size, ImGuiWindowFlags window_flags) => ImGuiMethods.BeginChildFrameEx(id, size, window_flags);
    ...
    public unsafe struct ImGuiIO : IImGuiIO
    {
        ...
        public readonly ImVector<uint> InputQueueCharacters => ((ImGuiIOStruct*)NativePointer)->InputQueueCharacters;
    ...
    public unsafe struct ImGuiTextFilter : IImGuiTextFilter
    {
        ...
        public readonly ImStructVectorWrapper<IImGuiTextFilter_ImGuiTextRange> Filters => new ImStructVectorWrapper<IImGuiTextFilter_ImGuiTextRange>(Unsafe.Read<ImVector>(&((ImGuiTextFilterStruct*)NativePointer)->Filters), Unsafe.SizeOf<ImGuiTextFilter_ImGuiTextRangeStruct>(), (addr) => new ImGuiTextFilter_ImGuiTextRange((ImGuiTextFilter_ImGuiTextRangeStruct*)addr));
    ...
    public unsafe struct ImGuiTextBuffer : IImGuiTextBuffer
    {
        ...
        public readonly ImVector<byte> Buf => ((ImGuiTextBufferStruct*)NativePointer)->Buf;
    }
    ...
    public unsafe struct ImGuiStorage : IImGuiStorage
    {
        ...
        public readonly ImStructVectorWrapper<IImGuiStoragePair> Data => new ImStructVectorWrapper<IImGuiStoragePair>(Unsafe.Read<ImVector>(&((ImGuiStorageStruct*)NativePointer)->Data), Unsafe.SizeOf<ImGuiStoragePairStruct>(), (addr) => new ImGuiStoragePair((ImGuiStoragePairStruct*)addr));
    }
    ...
    public unsafe struct ImGuiMultiSelectIO : IImGuiMultiSelectIO
    {
        ...
        public readonly ImStructVectorWrapper<IImGuiSelectionRequest> Requests => new ImStructVectorWrapper<IImGuiSelectionRequest>(Unsafe.Read<ImVector>(&((ImGuiMultiSelectIOStruct*)NativePointer)->Requests), Unsafe.SizeOf<ImGuiSelectionRequestStruct>(), (addr) => new ImGuiSelectionRequest((ImGuiSelectionRequestStruct*)addr));
    ...
    public unsafe struct ImDrawCmd : IImDrawCmd
    {
        ...
        public readonly ref ImTextureRef TexRef => ref Unsafe.AsRef<ImTextureRef>(&((ImDrawCmdStruct*)NativePointer)->TexRef);
    ...
    public unsafe struct ImDrawCmdHeader : IImDrawCmdHeader
    {
        ...
        public readonly ref ImTextureRef TexRef => ref Unsafe.AsRef<ImTextureRef>(&((ImDrawCmdHeaderStruct*)NativePointer)->TexRef);
    ...
    public unsafe struct ImDrawChannel : IImDrawChannel
    {
        ...
        public readonly ImStructVectorWrapper<IImDrawCmd> _CmdBuffer => new ImStructVectorWrapper<IImDrawCmd>(Unsafe.Read<ImVector>(&((ImDrawChannelStruct*)NativePointer)->_CmdBuffer), Unsafe.SizeOf<ImDrawCmdStruct>(), (addr) => new ImDrawCmd((ImDrawCmdStruct*)addr));
        public readonly ImVector<ushort> _IdxBuffer => ((ImDrawChannelStruct*)NativePointer)->_IdxBuffer;
    }
    ...
    public unsafe struct ImDrawListSplitter : IImDrawListSplitter
    {
        ...
        public readonly ImStructVectorWrapper<IImDrawChannel> _Channels => new ImStructVectorWrapper<IImDrawChannel>(Unsafe.Read<ImVector>(&((ImDrawListSplitterStruct*)NativePointer)->_Channels), Unsafe.SizeOf<ImDrawChannelStruct>(), (addr) => new ImDrawChannel((ImDrawChannelStruct*)addr));
    }
    ...
    public unsafe struct ImDrawList : IImDrawList
    {
        ...
        public readonly ImStructVectorWrapper<IImDrawCmd> CmdBuffer => new ImStructVectorWrapper<IImDrawCmd>(Unsafe.Read<ImVector>(&((ImDrawListStruct*)NativePointer)->CmdBuffer), Unsafe.SizeOf<ImDrawCmdStruct>(), (addr) => new ImDrawCmd((ImDrawCmdStruct*)addr));
        public readonly ImVector<ushort> IdxBuffer => ((ImDrawListStruct*)NativePointer)->IdxBuffer;
        public readonly ImStructVectorWrapper<IImDrawVert> VtxBuffer => new ImStructVectorWrapper<IImDrawVert>(Unsafe.Read<ImVector>(&((ImDrawListStruct*)NativePointer)->VtxBuffer), Unsafe.SizeOf<ImDrawVertStruct>(), (addr) => new ImDrawVert((ImDrawVertStruct*)addr));
        ...
        public readonly ImVector<Vector2> _Path => ((ImDrawListStruct*)NativePointer)->_Path;
        ...
        public readonly ImVector<Vector4> _ClipRectStack => ((ImDrawListStruct*)NativePointer)->_ClipRectStack;
        public readonly ImVector<ImTextureRef> _TextureStack => ((ImDrawListStruct*)NativePointer)->_TextureStack;
        public readonly ImVector<byte> _CallbacksDataBuf => ((ImDrawListStruct*)NativePointer)->_CallbacksDataBuf;
    ...
    public unsafe struct ImDrawData : IImDrawData
    {
        ...
        public readonly ImStructPtrVectorWrapper<IImDrawList> CmdLists => new ImStructPtrVectorWrapper<IImDrawList>(Unsafe.Read<ImVector>(&((ImDrawDataStruct*)NativePointer)->CmdLists), (addr) => new ImDrawList((ImDrawListStruct*)addr));
        ...
        public readonly ImStructPtrVectorPtrWrapper<IImTextureData> Textures => new ImStructPtrVectorPtrWrapper<IImTextureData>((nint)(&(((ImDrawDataStruct*)NativePointer)->Textures)), (addr) => new ImTextureData((ImTextureDataStruct*)addr));
    }
    ...
    public unsafe struct ImTextureData : IImTextureData
    {
        ...
        public readonly ImStructVectorWrapper<IImTextureRect> Updates => new ImStructVectorWrapper<IImTextureRect>(Unsafe.Read<ImVector>(&((ImTextureDataStruct*)NativePointer)->Updates), Unsafe.SizeOf<ImTextureRectStruct>(), (addr) => new ImTextureRect((ImTextureRectStruct*)addr));
    ...
    public unsafe struct ImFontGlyphRangesBuilder : IImFontGlyphRangesBuilder
    {
        ...
        public readonly ImVector<uint> UsedChars => ((ImFontGlyphRangesBuilderStruct*)NativePointer)->UsedChars;
    }
    ...
    public unsafe struct ImFontAtlas : IImFontAtlas
    {
        ...
        public readonly ImStructPtrVectorWrapper<IImTextureData> TexList => new ImStructPtrVectorWrapper<IImTextureData>(Unsafe.Read<ImVector>(&((ImFontAtlasStruct*)NativePointer)->TexList), (addr) => new ImTextureData((ImTextureDataStruct*)addr));
        ...
        public readonly ImStructPtrVectorWrapper<IImFont> Fonts => new ImStructPtrVectorWrapper<IImFont>(Unsafe.Read<ImVector>(&((ImFontAtlasStruct*)NativePointer)->Fonts), (addr) => new ImFont((ImFontStruct*)addr));
        public readonly ImStructVectorWrapper<IImFontConfig> Sources => new ImStructVectorWrapper<IImFontConfig>(Unsafe.Read<ImVector>(&((ImFontAtlasStruct*)NativePointer)->Sources), Unsafe.SizeOf<ImFontConfigStruct>(), (addr) => new ImFontConfig((ImFontConfigStruct*)addr));
        ...
        public readonly ImStructPtrVectorWrapper<IImDrawListSharedData> DrawListSharedDatas => new ImStructPtrVectorWrapper<IImDrawListSharedData>(Unsafe.Read<ImVector>(&((ImFontAtlasStruct*)NativePointer)->DrawListSharedDatas), (addr) => new ImDrawListSharedData((ImDrawListSharedDataStruct*)addr));
        ...
        public readonly ref ImTextureRef TexRef => ref ((ImFontAtlasStruct*)NativePointer)->TexRef;
        public readonly ref ImTextureRef TexID => ref ((ImFontAtlasStruct*)NativePointer)->TexID;
    }
    ...
    public unsafe struct ImFontBaked : IImFontBaked
    {
        ...
        public readonly ImVector<float> IndexAdvanceX => ((ImFontBakedStruct*)NativePointer)->IndexAdvanceX;
        ...
        public readonly ImVector<ushort> IndexLookup => ((ImFontBakedStruct*)NativePointer)->IndexLookup;
        public readonly ImStructVectorWrapper<IImFontGlyph> Glyphs => new ImStructVectorWrapper<IImFontGlyph>(Unsafe.Read<ImVector>(&((ImFontBakedStruct*)NativePointer)->Glyphs), Unsafe.SizeOf<ImFontGlyphStruct>(), (addr) => new ImFontGlyph((ImFontGlyphStruct*)addr));
    ...
    public unsafe struct ImFont : IImFont
    {
        ...
        public readonly ImStructPtrVectorWrapper<IImFontConfig> Sources => new ImStructPtrVectorWrapper<IImFontConfig>(Unsafe.Read<ImVector>(&((ImFontStruct*)NativePointer)->Sources), (addr) => new ImFontConfig((ImFontConfigStruct*)addr));
    ...
    public unsafe struct ImGuiPlatformIO : IImGuiPlatformIO
    {
        ...
        public readonly ImStructVectorWrapper<IImGuiPlatformMonitor> Monitors => new ImStructVectorWrapper<IImGuiPlatformMonitor>(Unsafe.Read<ImVector>(&((ImGuiPlatformIOStruct*)NativePointer)->Monitors), Unsafe.SizeOf<ImGuiPlatformMonitorStruct>(), (addr) => new ImGuiPlatformMonitor((ImGuiPlatformMonitorStruct*)addr));
        public readonly ImStructPtrVectorWrapper<IImTextureData> Textures => new ImStructPtrVectorWrapper<IImTextureData>(Unsafe.Read<ImVector>(&((ImGuiPlatformIOStruct*)NativePointer)->Textures), (addr) => new ImTextureData((ImTextureDataStruct*)addr));
        public readonly ImStructPtrVectorWrapper<IImGuiViewport> Viewports => new ImStructPtrVectorWrapper<IImGuiViewport>(Unsafe.Read<ImVector>(&((ImGuiPlatformIOStruct*)NativePointer)->Viewports), (addr) => new ImGuiViewport((ImGuiViewportStruct*)addr));
    }
    ...
    {
        var retPtr = ImGuiMethods.ImGuiFreeTypeGetFontLoader();
        if (retPtr is null)
        return null !;
        var retImpl = new ImFontLoader(retPtr);
        return retImpl;
    }
