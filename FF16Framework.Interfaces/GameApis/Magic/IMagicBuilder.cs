...
public record MagicModification
{
    ...
    /// For AddOperation with multiple properties, this is the first property ID.
    /// </summary>
    public int PropertyId { get; init; }
    
    /// <summary>
    /// The value to set (int, float, Vector3, or bool).
    /// For AddOperation with multiple properties, this is a list of (propertyId, value) tuples.
    /// </summary>
    public object? Value { get; init; }
    
    /// <summary>
    /// For AddOperation: List of additional property IDs (beyond the first one in PropertyId).
    /// </summary>
    public IList<int>? AdditionalPropertyIds { get; init; }
...
public class MagicModificationConfig
{
    ...
    /// <summary>
    /// For AddOperation: list of properties with their values.
...
/// <summary>
/// A property-value pair for JSON serialization.
/// </summary>
